                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="address" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Address here.">{{isset($client->address) ? $client->address : ''}}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="waba_id"
                                       value="{{isset($client->waba_id) ? $client->waba_id : ''}}"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                        ...
                        <div class="col-md-6">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="phone_number_id"
                                       ...
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="Please Enter Phone Number ID."/>
                            </div>
                        </div>
