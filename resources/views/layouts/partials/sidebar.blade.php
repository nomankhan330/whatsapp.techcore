        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @if (Auth::user()->hasRole('client'))
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Route::currentRouteName() == 'contact_group.show' || Route::currentRouteName() == 'contact_group.index' ? 'active' : '' }}"
                           href="{{ route('contact_group.index') }}">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="menu-item">
                        <a class="menu-link" onclick="addDataSingleMessage()" href="javascript:void(0)">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                    ...
                    <div class="menu-item">
                        <a class="menu-link" onclick="addDataBulkMessage()" href="javascript:void(0)">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                                <span class="svg-icon svg-icon-2 svg-icon-primary">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Route::currentRouteName() == 'scheduled_detail.index' || Route::currentRouteName() == 'scheduled_detail.show' ? 'active' : '' }}"
                            ...
                            <span class="menu-title">View Scheduled Details</span>
                        </a>
                    </div>
...
<script>
    function addDataSingleMessage() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $('#right_modal_header').html('Send Single Message');
                $('#right_modal_body').html(result);
                $('#right_modal_footer').html(_footersidebarsingle);
                drawer.toggle();
    ...
    function addDataBulkMessage() {
        ...
        $.ajax({
            type: 'GET',
            url: "{{ route('send_bulk_message') }}",
            success: function(result) {
                let drawerElement = document.querySelector("#right_modal");
                $("#right_modal").attr("data-kt-drawer-width", "{default:'350px', 'lg': '640px'}");
                $("#right_modal").attr('style', 'width: 640px !important')
                let drawer = KTDrawer.getInstance(drawerElement);
                $('#right_modal_header').html('Send Bulk Message');
                $('#right_modal_body').html(result);
                $('#right_modal_footer').html(_footersidebarbulk);
                drawer.toggle();
