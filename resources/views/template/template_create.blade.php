    ...
    <form id="client_from" class="form" method="POST" action="{{ route('client.store') }}">
        @else
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="fv-row mb-7">
                                <select class="form-select form-select-solid fw-bolder js-example-basic-single" data-kt-select2="true"
                                        data-placeholder="Select Header" data-allow-clear="true" data-dropdown-parent="#right_modal" id="ddlHeader">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="fv-row mb-7">
                                <textarea class="form-control form-control-solid mb-3 mb-lg-0 kt_docs_maxlength_textarea_1024" id="body_text" maxlength="1024" placeholder="" rows="6"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="row" id="divText" style="display: none;">
                        ...
                        <div class="col-md-5">
                            <div class="fv-row mb-7">
                                <textarea class="form-control form-control-solid mb-3 mb-lg-0 kt_docs_maxlength_textarea_60" id="" maxlength="60" placeholder="" rows="6"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <p style="margin: 0 0 10px;padding: 10px 0px 10px 10px;background-color: #eee;font-weight: 500;border-radius:8px;"><span style="color:initial;"><b>Notes:</b><br>1) Allowed only 1024 characters.<br>
            ...
            <script>
                ...
                var _html = `<table class="table table-row-bordered" id="variableTable">
                                <thead>
                                ...
                                <tbody class="fw-bold">
                                    ...
                                    @for ($i = 1; $i < 25; $i++)
                                        <tr>
                                            <td>{{$i}}</td>
                                            <td><button type="button" class="btn btn-success btn-sm btnAdd" value="[{{$i}}]">Add Variables</button></td>
                                        </tr>
                                    @endfor
                ...
                $(document).ready(function() {
                    ...
                    $(document).on("click", ".btnAdd", function (e) {
                        ...
                        let id = this.id
                        let copyText = document.getElementById("myInput"+id);
                        ...
                        $("#body_text").val(body_text + copyText.value);
                        $("#myModalMd").modal("hide");

                        /*let variables = this.id;
                        variables = variables.replace('[', '@{{');
                        variables = variables.replace(']', '}}');
                        var bodyText= $("#body_text").text();
                        bodyText +=variables;
