        ...
        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true"
            ...
            <div class="fv-row mb-7">
                ...
                <select class="form-select form-select-solid fw-bolder js-example-basic-single" data-kt-select2="true"
                    data-placeholder="Select Contact Number" id="contact_number" name="contact_number"
                    ...
                    @for ($i = 0; $i < count($contact); $i++)
                        <option value="{{ $contact[$i]->contact_number }}"> {{ $contact[$i]->contact_name }}
                            ({{ $contact[$i]->contact_number }}) </option>
                    @endfor
            ...
            <div class="fv-row mb-7">
                ...
                <select class="form-select form-select-solid fw-bolder js-example-basic-single" data-kt-select2="true"
                    data-placeholder="Select Template Name" id="template_name" name="template_name"
                    data-allow-clear="true" data-dropdown-parent="#right_modal">
                    <option></option>
            ...
            <div class="fv-row mb-7">
                ...
                <input type="text" value="" class="form-control form-control-solid mb-3 mb-lg-0"
                    placeholder="Enter Broadcast Name" id="broadcast_name" name="broadcast_name" required />
            </div>
            ...
            <div class="fv-row mb-7" id="cloneDiv" style="display: none">
                ...
                <input type="text" value="" class="form-control form-control-solid mb-3 mb-lg-0"
                    placeholder="Enter Value" name="param_" required />
            </div>
                        ...
                        if (result.code === '200') {
                            ...
                            if (result.button_type == "quick_reply") {
                                if (result.button_value.quick_reply_button_text_1 != "") {
                                    _html +=
                                        `<a href="javascript:;" class="btn btn-primary btn-sm col-sm-3">${result.button_value.quick_reply_button_text_1}</a> <br /> <br />`;
                                }
                                if (result.button_value.quick_reply_button_text_2 != "") {
                                    _html +=
                                        `<a href="javascript:;" class="btn btn-primary btn-sm col-sm-3">${result.button_value.quick_reply_button_text_2}</a> <br /> <br />`;
                                }
                                if (result.button_value.quick_reply_button_text_3 != "") {
                                    _html +=
                                        `<a href="javascript:;" class="btn btn-primary btn-sm col-sm-3">${result.button_value.quick_reply_button_text_3}</a> <br /> <br />`;
                                }
                            }
                            ...
                            if (result.button_type == "call_to_action") {
                                if (result.button_value.website_button_text != "") {
                                    _html +=
                                        `<a href="javascript:;" class="btn btn-primary btn-sm col-sm-3">${result.button_value.website_button_text}</a> <br /> <br />`;
                                }
                                if (result.button_value.phone_button_text != "") {
                                    _html +=
                                        `<a href="javascript:;" class="btn btn-primary btn-sm col-sm-3">${result.button_value.phone_button_text}</a> <br /> <br />`;
                                }
                            }
                            ...
                            if (params.length > 0) {
                                ...
                                for (let i = 0; i < params.length; i++) {
                                    ...
                                    _param_replace = _param_replace.replace(':::params',
                                        'key_' + params[i]);
