                        ...
                        <div class="card card-docs mb-2">
                            <div class="p-10 pb-0" style="display: none;">
                                ...
                                <h1 class="anchor fw-bolder mb-5" id="zero-configuration">
                                    <a href="javascript:;"></a>View Incoming Messages
                                </h1>
                            </div>
                            <!--begin::Card header-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            dt = $('#clientTable').DataTable({
                ...
                order: [[0, 'desc']],
                ajax: {
                    url: "{{ route('view_incoming_messages') }}",
                    data: function (d) {
                ...
                columns: [
                    ...
                    {data: 'whatsapp_contact_no', name: 'whatsapp_contact_no'},
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, row) {
                            let a = row.text;
                            a = a.length > 70 ? a.substr(0, 70)+'...' : row.text;
                            //return `<span data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip" data-bs-placement="bottom" title="${a}">${row.text}</span>`;
                            return `<span data-bs-toggle="tooltip" data-bs-placement="bottom" title="${row.text}">${a}</span>`;
                        }
                    },
                ],
                aLengthMenu: [
