                        ...
                        <div class="card card-docs mb-2">
                            <div class="p-10 pb-0" style="display: none;">
                                ...
                                <h1 class="anchor fw-bolder mb-5" id="zero-configuration">
                                    <a href="javascript:;"></a>View Failed Outgoing Messages
                                </h1>
                            </div>
                            <!--begin::Card header-->
                                ...
                                <div class="card-toolbar" style="display: none;">
                                    <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px"
                                             data-kt-menu="true" style="display: none;">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                            ...
                                            <div class="px-7 py-5">
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <select class="form-select form-select-solid fw-bolder"
                                                            id="read_status" data-kt-select2="true"
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <button type="reset"
                                                            ...
                                                            onclick="clearFilter() ">Reset
                                                    </button>
                                                    <button type="submit" class="btn btn-primary"
                                                            data-kt-menu-dismiss="true"
                                                            data-kt-customer-table-filter="filter"
                                                            onclick="filterData2()">Apply
                                                    </button>
                                                </div>
                                                <!--end::Actions-->
                                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            dt = $('#clientTable').DataTable({
                ...
                order: [[0, 'desc']],
                ajax: {
                    url: "{{ route('view_failed_outgoing_messages') }}",
                    data: function (d) {
